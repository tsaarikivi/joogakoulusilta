import { UPDATE_USERS_BOOKINGS, UPDATE_USERS_TRANSACTIONS,USER_ERROR, USER_DETAILS_UPDATED_IN_DB, STOP_UPDATING_USER_DETAILS_FROM_DB } from '../actions/actionTypes.js'
...
export default function(state = INITIAL_STATE, action) {
  switch (action.type) {
    case UPDATE_USERS_BOOKINGS:
      console.log("UPDATE_USERS_BOOKINGS", action.payload);
